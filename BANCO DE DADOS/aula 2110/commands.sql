...
SELECT "course_id", COUNT(*) AS "aulas" FROM "lessons" GROUP BY "course_id";

SELECT "course_id", SUM ("seconds") AS "total_seconds" FROM "lessons" GROUP BY "course_id" ORDER BY "total_seconds" DESC;

SELECT "course_id", SUM ("seconds") AS "total_seconds" FROM "lessons" GROUP BY "course_id" HAVING SUM ("seconds") > 2300 ORDER BY "total_seconds" DESC;
